...
#ifndef _bd_2743_0_slot_5_b_0_core_h_
#define _bd_2743_0_slot_5_b_0_core_h_
...
class bd_2743_0_slot_5_b_0_core : public sc_module 
{
    public: 
       bd_2743_0_slot_5_b_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(bd_2743_0_slot_5_b_0_core);
    ...
    virtual ~bd_2743_0_slot_5_b_0_core() = default;
