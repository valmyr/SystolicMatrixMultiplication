...
design_libs=(xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_22 zynq_ultra_ps_e_vip_v1_0_22 xil_defaultlib proc_sys_reset_v5_0_17 smartconnect_v1_0 axi_register_slice_v2_1_36 axi_lite_ipif_v3_0_4 axi_fifo_mm_s_v4_3_7 gigantic_mux xlconcat_v2_1_7)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.SystolicCore_wrapper xil_defaultlib.glbl -o SystolicCore_wrapper_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./SystolicCore_wrapper_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key SystolicCore_wrapper_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc SystolicCore_wrapper_simv.daidir vcs_lib c.obj)
