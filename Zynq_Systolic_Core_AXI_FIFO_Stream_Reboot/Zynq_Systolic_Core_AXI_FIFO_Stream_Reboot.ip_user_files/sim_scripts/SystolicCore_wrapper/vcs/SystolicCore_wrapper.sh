...
design_libs=(xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_22 zynq_ultra_ps_e_vip_v1_0_22 xil_defaultlib proc_sys_reset_v5_0_17 smartconnect_v1_0 axi_register_slice_v2_1_36 axi_lite_ipif_v3_0_4 axi_fifo_mm_s_v4_3_7)
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/xmen/Videos/RustDesk/SystolicCore/SystolicCore/Zynq_Systolic_Core_AXI_FIFO_Stream_Reboot/Zynq_Systolic_Core_AXI_FIFO_Stream_Reboot.cache/compile_simlib/vcs"
  fi
