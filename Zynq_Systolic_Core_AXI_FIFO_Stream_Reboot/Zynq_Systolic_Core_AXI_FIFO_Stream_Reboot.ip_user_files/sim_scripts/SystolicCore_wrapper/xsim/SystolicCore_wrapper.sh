...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_22 -L zynq_ultra_ps_e_vip_v1_0_22 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_36 -L axi_lite_ipif_v3_0_4 -L axi_fifo_mm_s_v4_3_7 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot SystolicCore_wrapper xil_defaultlib.SystolicCore_wrapper xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim SystolicCore_wrapper -key {Behavioral:sim_1:Functional:SystolicCore_wrapper} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_76f3.protoinst" -protoinst "protoinst_files/SystolicCore_wrapper.protoinst" -log simulate.log $*
}
