...
simulate()
{
  xsim ila_1 -key {Behavioral:sim_1:Functional:ila_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_ae77.protoinst" -protoinst "protoinst_files/SystolicCore_wrapper.protoinst" -protoinst "protoinst_files/bd_8f00.protoinst" -protoinst "protoinst_files/bd_8029.protoinst" -protoinst "protoinst_files/bd_2743.protoinst" -protoinst "protoinst_files/teste_dma.protoinst" -log simulate.log $*
}
