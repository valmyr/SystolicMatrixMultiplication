...
simulate()
{
  xsim matrix_in_memeory -key {Behavioral:sim_1:Functional:matrix_in_memeory} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_76f3.protoinst" -protoinst "protoinst_files/SystolicCore_wrapper.protoinst" -log simulate.log $*
}
