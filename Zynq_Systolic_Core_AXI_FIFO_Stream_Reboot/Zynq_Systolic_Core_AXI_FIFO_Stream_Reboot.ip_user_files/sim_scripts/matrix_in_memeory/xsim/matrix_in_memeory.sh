...
export RDI_DATADIR="/home/xmen/Music/2025.2/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot matrix_in_memeory xil_defaultlib.matrix_in_memeory xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim matrix_in_memeory -key {Behavioral:sim_1:Functional:matrix_in_memeory} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_ae77.protoinst" -protoinst "protoinst_files/SystolicCore_wrapper.protoinst" -protoinst "protoinst_files/bd_8f00.protoinst" -protoinst "protoinst_files/bd_8029.protoinst" -protoinst "protoinst_files/bd_2743_0.protoinst" -protoinst "protoinst_files/teste_dma.protoinst" -log simulate.log $*
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/xmen/Music/2025.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb matrix_in_memeory.wdb xsim.dir libdpi.so)
