...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../../../../../../Music/2025.2/data/rsb/busdef" +incdir+"/home/xmen/Music/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../Music/2025.2/data/rsb/busdef" +incdir+"/home/xmen/Music/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_12 $xmvlog_opts +incdir+"../../../../../../../../../Music/2025.2/data/rsb/busdef" +incdir+"/home/xmen/Music/2025.2/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../../Music/2025.2/data/rsb/busdef" +incdir+"/home/xmen/Music/2025.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.matrix_in_memeory xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.matrix_in_memeory -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log matrix_in_memeory_sc.so .tmp_log xcelium_lib waves.shm c.obj)
