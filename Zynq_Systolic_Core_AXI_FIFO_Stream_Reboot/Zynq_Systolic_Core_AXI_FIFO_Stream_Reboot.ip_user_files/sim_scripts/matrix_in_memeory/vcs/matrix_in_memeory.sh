...
#
# Script generated by Vivado on Wed Feb 25 00:12:00 -03 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : matrix_in_memeory.sh
...
#
# Usage        : matrix_in_memeory.sh
#                matrix_in_memeory.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                matrix_in_memeory.sh [-rerun]
#                matrix_in_memeory.sh [-reset_run]
#                matrix_in_memeory.sh [-clean]
#                matrix_in_memeory.sh [-reset_log]
#                matrix_in_memeory.sh [-help]
#
...
#                script (type 'matrix_in_memeory.sh -help' for more information).
#
...
# script info
echo -e "matrix_in_memeory.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./matrix_in_memeory.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../../../../../../Music/2025.2/data/rsb/busdef" +incdir+"/home/xmen/Music/2025.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../Music/2025.2/data/rsb/busdef" +incdir+"/home/xmen/Music/2025.2/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_12 $vlogan_opts +v2k +incdir+"../../../../../../../../../Music/2025.2/data/rsb/busdef" +incdir+"/home/xmen/Music/2025.2/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../../Music/2025.2/data/rsb/busdef" +incdir+"/home/xmen/Music/2025.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.matrix_in_memeory xil_defaultlib.glbl -o matrix_in_memeory_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./matrix_in_memeory_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key matrix_in_memeory_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc matrix_in_memeory_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./matrix_in_memeory.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: matrix_in_memeory.sh [-help]\n\
Usage: matrix_in_memeory.sh [-step]\n\
Usage: matrix_in_memeory.sh [-lib_map_path]\n\
Usage: matrix_in_memeory.sh [-rerun]\n\
Usage: matrix_in_memeory.sh [-reset_run]\n\
Usage: matrix_in_memeory.sh [-clean]\n\
Usage: matrix_in_memeory.sh [-reset_log]\n\
Usage: matrix_in_memeory.sh [-keep_index]\n\
Usage: matrix_in_memeory.sh [-noclean_files]\n\n\
