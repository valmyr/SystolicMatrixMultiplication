...
#
# Script generated by Vivado on Wed Jan 28 11:49:11 -03 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ram_dual_port.sh
...
#
# Usage        : ram_dual_port.sh
#                ram_dual_port.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ram_dual_port.sh [-rerun]
#                ram_dual_port.sh [-reset_run]
#                ram_dual_port.sh [-clean]
#                ram_dual_port.sh [-reset_log]
#                ram_dual_port.sh [-help]
#
...
#                script (type 'ram_dual_port.sh -help' for more information).
#
...
# script info
echo -e "ram_dual_port.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ram_dual_port.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ram_dual_port xil_defaultlib.glbl -o ram_dual_port_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ram_dual_port_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ram_dual_port_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ram_dual_port_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ram_dual_port.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ram_dual_port.sh [-help]\n\
Usage: ram_dual_port.sh [-step]\n\
Usage: ram_dual_port.sh [-lib_map_path]\n\
Usage: ram_dual_port.sh [-rerun]\n\
Usage: ram_dual_port.sh [-reset_run]\n\
Usage: ram_dual_port.sh [-clean]\n\
Usage: ram_dual_port.sh [-reset_log]\n\
Usage: ram_dual_port.sh [-keep_index]\n\
Usage: ram_dual_port.sh [-noclean_files]\n\n\
