...
simulate()
{
  xsim ram_dual_port -key {Behavioral:sim_1:Functional:ram_dual_port} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_76f3.protoinst" -protoinst "protoinst_files/SystolicCore_wrapper.protoinst" -log simulate.log $*
}
