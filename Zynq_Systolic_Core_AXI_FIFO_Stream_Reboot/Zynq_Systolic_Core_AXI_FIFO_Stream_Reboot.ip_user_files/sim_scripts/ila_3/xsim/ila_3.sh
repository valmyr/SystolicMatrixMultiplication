...
simulate()
{
  xsim ila_3 -key {Behavioral:sim_1:Functional:ila_3} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_ae77.protoinst" -protoinst "protoinst_files/bd_8f00.protoinst" -protoinst "protoinst_files/bd_8029.protoinst" -protoinst "protoinst_files/bd_2743_0.protoinst" -protoinst "protoinst_files/teste_dma.protoinst" -log simulate.log $*
}
