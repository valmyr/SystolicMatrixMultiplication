...
simulate()
{
  xsim ila_0 -key {Behavioral:sim_1:Functional:ila_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_76f3.protoinst" -protoinst "protoinst_files/SystolicCore_wrapper.protoinst" -log simulate.log $*
}
