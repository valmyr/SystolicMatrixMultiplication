...
HD_PWD='/home/valmyrsilva07/Área de Trabalho/SystolicCore/Zynq_Systolic_Core_AXI_FIFO_Stream_Reboot/Zynq_Systolic_Core_AXI_FIFO_Stream_Reboot.runs/teste_dma_axis_data_fifo_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log teste_dma_axis_data_fifo_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source teste_dma_axis_data_fifo_0_0.tcl
