...
create_clock -period 3.000 -name clk_125mhz [get_ports clk_125mhz_p]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets rst_n_async_IBUF_inst/O]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets rst_n_async]
# LEDs
...
# Reset button
#set_property -dict {LOC G13 IOSTANDARD LVCMOS12} [get_ports nreset]

set_false_path -from [get_ports rst_n_async]
set_input_delay 0.000 [get_ports rst_n_async]
...
# DIP switches
set_property -dict {LOC A17  IOSTANDARD LVCMOS18} [get_ports {rst_n_async}]
