...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_22 -L zynq_ultra_ps_e_vip_v1_0_22 -L axi_lite_ipif_v3_0_4 -L axi_fifo_mm_s_v4_3_7 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_36 -L gigantic_mux -L axi_timer_v2_0_37 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot SystolicCore xil_defaultlib.SystolicCore xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim SystolicCore -key {Behavioral:sim_1:Functional:SystolicCore} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_3e58.protoinst" -protoinst "protoinst_files/bd_d645.protoinst" -protoinst "protoinst_files/SystolicCore.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb SystolicCore.wdb xsim.dir libdpi.so)
