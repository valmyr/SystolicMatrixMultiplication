...
simulate()
{
  xsim ila_1 -key {Behavioral:sim_1:Functional:ila_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_3e58.protoinst" -protoinst "protoinst_files/SystolicCore.protoinst" -log simulate.log
}
