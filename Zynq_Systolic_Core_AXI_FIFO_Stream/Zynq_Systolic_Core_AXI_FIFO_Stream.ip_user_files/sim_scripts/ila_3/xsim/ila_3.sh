...
simulate()
{
  xsim ila_3 -key {Behavioral:sim_1:Functional:ila_3} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_3e58.protoinst" -protoinst "protoinst_files/bd_d645.protoinst" -protoinst "protoinst_files/SystolicCore.protoinst" -log simulate.log
}
