...
simulate()
{
  xsim ram_dual_port -key {Behavioral:sim_1:Functional:ram_dual_port} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_3e58.protoinst" -protoinst "protoinst_files/SystolicCore.protoinst" -log simulate.log
}
