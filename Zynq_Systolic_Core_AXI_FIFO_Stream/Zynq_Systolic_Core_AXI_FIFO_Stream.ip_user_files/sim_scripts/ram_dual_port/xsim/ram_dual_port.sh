...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ram_dual_port xil_defaultlib.ram_dual_port xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ram_dual_port -key {Behavioral:sim_1:Functional:ram_dual_port} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_3e58.protoinst" -protoinst "protoinst_files/bd_d645.protoinst" -protoinst "protoinst_files/SystolicCore.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ram_dual_port.wdb xsim.dir libdpi.so)
