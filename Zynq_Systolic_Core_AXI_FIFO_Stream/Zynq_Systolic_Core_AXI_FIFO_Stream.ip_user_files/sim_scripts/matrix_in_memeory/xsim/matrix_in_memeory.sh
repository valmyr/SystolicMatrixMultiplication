...
simulate()
{
  xsim matrix_in_memeory -key {Behavioral:sim_1:Functional:matrix_in_memeory} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_3e58.protoinst" -protoinst "protoinst_files/SystolicCore.protoinst" -log simulate.log
}
