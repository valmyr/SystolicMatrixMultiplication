...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clka, ena, wea, addra, dina, clkb, rstb, enb, addrb, doutb, 
  rsta_busy, rstb_busy)
/* synthesis syn_black_box black_box_pad_pin="ena,wea[0:0],addra[7:0],dina[7:0],rstb,enb,addrb[7:0],doutb[7:0],rsta_busy,rstb_busy" */
