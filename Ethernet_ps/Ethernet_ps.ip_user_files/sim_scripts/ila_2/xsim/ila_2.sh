...
simulate()
{
  xsim ila_2 -key {Behavioral:sim_1:Functional:ila_2} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
