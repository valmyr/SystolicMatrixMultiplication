...
#
# Script generated by Vivado on Wed Nov 26 17:05:22 -03 2025
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dual_porte_ram.sh
...
#
# Usage        : dual_porte_ram.sh
#                dual_porte_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dual_porte_ram.sh [-rerun]
#                dual_porte_ram.sh [-reset_run]
#                dual_porte_ram.sh [-clean]
#                dual_porte_ram.sh [-reset_log]
#                dual_porte_ram.sh [-help]
#
...
#                script (type 'dual_porte_ram.sh -help' for more information).
#
...
# script info
echo -e "dual_porte_ram.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dual_porte_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dual_porte_ram xil_defaultlib.glbl -o dual_porte_ram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dual_porte_ram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key dual_porte_ram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dual_porte_ram_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dual_porte_ram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dual_porte_ram.sh [-help]\n\
Usage: dual_porte_ram.sh [-step]\n\
Usage: dual_porte_ram.sh [-lib_map_path]\n\
Usage: dual_porte_ram.sh [-rerun]\n\
Usage: dual_porte_ram.sh [-reset_run]\n\
Usage: dual_porte_ram.sh [-clean]\n\
Usage: dual_porte_ram.sh [-reset_log]\n\
Usage: dual_porte_ram.sh [-keep_index]\n\
Usage: dual_porte_ram.sh [-noclean_files]\n\n\
