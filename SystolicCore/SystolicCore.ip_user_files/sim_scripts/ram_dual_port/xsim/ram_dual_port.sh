...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ram_dual_port xil_defaultlib.ram_dual_port xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ram_dual_port -key {Behavioral:sim_1:Functional:ram_dual_port} -tclbatch cmd.tcl -log simulate.log
}
