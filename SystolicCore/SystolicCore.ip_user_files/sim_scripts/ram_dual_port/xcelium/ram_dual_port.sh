...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../Music/2025.2/data/rsb/busdef" \
  ...
  xmvlog -work blk_mem_gen_v8_4_12 $xmvlog_opts +incdir+"../../../../../../../../Music/2025.2/data/rsb/busdef" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../Music/2025.2/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/xmen/Desktop/PROJETO_TCC/SystolicCore/SystolicCore/SystolicCore.cache/compile_simlib/xcelium"
  fi
