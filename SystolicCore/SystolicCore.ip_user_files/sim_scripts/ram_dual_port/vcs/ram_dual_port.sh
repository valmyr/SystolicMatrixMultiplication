...
#
# Script generated by Vivado on Wed Dec 24 23:47:51 -03 2025
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/xmen/Videos/SystolicCore/SystolicCore/SystolicCore.cache/compile_simlib/vcs"
  fi
