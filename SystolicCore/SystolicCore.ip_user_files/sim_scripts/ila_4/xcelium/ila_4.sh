...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../../../../../../Music/2025.2/data/rsb/busdef" +incdir+"../../../../SystolicCore.gen/sources_1/ip/ila_4/hdl/verilog" +incdir+"/home/xmen/Music/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../Music/2025.2/data/rsb/busdef" +incdir+"../../../../SystolicCore.gen/sources_1/ip/ila_4/hdl/verilog" +incdir+"/home/xmen/Music/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../../Music/2025.2/data/rsb/busdef" +incdir+"../../../../SystolicCore.gen/sources_1/ip/ila_4/hdl/verilog" +incdir+"/home/xmen/Music/2025.2/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/xmen/Videos/RustDesk/SystolicCore/SystolicCore/SystolicCore/SystolicCore.cache/compile_simlib/xcelium"
  fi
