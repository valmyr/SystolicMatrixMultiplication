...
// Command     : write_verilog -force -mode synth_stub -rename_top Systolic_DMA_AXI_Stream_axi_smc_1_0 -prefix
//               Systolic_DMA_AXI_Stream_axi_smc_1_0_ Systolic_DMA_AXI_Stream_axi_smc_1_0_stub.v
...
(* CHECK_LICENSE_TYPE = "Systolic_DMA_AXI_Stream_axi_smc_1_0,bd_e34f,{}" *) (* CORE_GENERATION_INFO = "Systolic_DMA_AXI_Stream_axi_smc_1_0,bd_e34f,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=28,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_e34f,Vivado 2025.2" *) 
module Systolic_DMA_AXI_Stream_axi_smc_1_0(aclk, aresetn, S00_AXI_araddr, S00_AXI_arlen, 
