...
-- Date        : Wed Mar 18 15:53:12 2026
-- Host        : VT0144 running 64-bit Rocky Linux release 8.10 (Green Obsidian)
-- Command     : write_vhdl -force -mode synth_stub -rename_top Systolic_DMA_AXI_Stream_axi_smc_1_0 -prefix
--               Systolic_DMA_AXI_Stream_axi_smc_1_0_ Systolic_DMA_AXI_Stream_axi_smc_1_0_stub.vhdl
-- Design      : Systolic_DMA_AXI_Stream_axi_smc_1_0
...
entity Systolic_DMA_AXI_Stream_axi_smc_1_0 is
  Port ( 
    aclk : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of Systolic_DMA_AXI_Stream_axi_smc_1_0 : entity is "Systolic_DMA_AXI_Stream_axi_smc_1_0,bd_e34f,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of Systolic_DMA_AXI_Stream_axi_smc_1_0 : entity is "Systolic_DMA_AXI_Stream_axi_smc_1_0,bd_e34f,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=28,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of Systolic_DMA_AXI_Stream_axi_smc_1_0 : entity is "yes";
end Systolic_DMA_AXI_Stream_axi_smc_1_0;

architecture stub of Systolic_DMA_AXI_Stream_axi_smc_1_0 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 299970032, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN Systolic_DMA_AXI_Stream_zynq_ultra_ps_e_0_0_pl_clk0, ASSOCIATED_BUSIF M00_AXI:S00_AXI:S01_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN m_sc_aclken";
  ...
  attribute X_INTERFACE_PARAMETER of S01_AXI_awaddr : signal is "XIL_INTERFACENAME S01_AXI, DATA_WIDTH 64, PROTOCOL AXI4, FREQ_HZ 299970032, ID_WIDTH 0, ADDR_WIDTH 32, AWUSER_WIDTH 0, ARUSER_WIDTH 0, WUSER_WIDTH 0, RUSER_WIDTH 0, BUSER_WIDTH 0, READ_WRITE_MODE WRITE_ONLY, HAS_BURST 0, HAS_LOCK 0, HAS_PROT 1, HAS_CACHE 1, HAS_QOS 0, HAS_REGION 0, HAS_WSTRB 1, HAS_BRESP 1, HAS_RRESP 0, SUPPORTS_NARROW_BURST 0, NUM_READ_OUTSTANDING 2, NUM_WRITE_OUTSTANDING 16, MAX_BURST_LENGTH 256, PHASE 0.0, CLK_DOMAIN Systolic_DMA_AXI_Stream_zynq_ultra_ps_e_0_0_pl_clk0, NUM_READ_THREADS 1, NUM_WRITE_THREADS 1, RUSER_BITS_PER_BYTE 0, WUSER_BITS_PER_BYTE 0, INSERT_VIP 0";
  ...
  attribute X_CORE_INFO of stub : architecture is "bd_e34f,Vivado 2025.2";
begin
end;
