...
//--------------------------------------------------------------------------------
//Command: generate_target bd_e34f.bd
//Design : bd_e34f
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_e34f,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_e34f,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=35,numReposBlks=27,numNonXlnxBlks=0,numHierBlks=8,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "Systolic_DMA_AXI_Stream_axi_smc_1_0.hwdef" *) 
module bd_e34f
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
  ...
  m00_exit_pipeline_imp_1RVDBCZ m00_exit_pipeline
  ...
  m00_nodes_imp_1EI87AN m00_nodes
  ...
  s00_entry_pipeline_imp_S1XWW0 s00_entry_pipeline
       (.aclk(aclk_1),
        .aresetn(aresetn_2),
  ...
  s00_nodes_imp_V93G0Q s00_nodes
  ...
  s01_entry_pipeline_imp_1YL7H1W s01_entry_pipeline
       (.aclk(aclk_2),
        .aresetn(aresetn_3),
  ...
  s01_nodes_imp_1TY2X0S s01_nodes
  ...
  switchboards_imp_7L12VI switchboards
...
module m00_exit_pipeline_imp_1RVDBCZ
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arburst,
...
module s00_entry_pipeline_imp_S1XWW0
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_e34f_s00mmu_0 s00_mmu
       (.aclk(aclk),
        ...
        .s_axi_rresp(s_axi_rresp),
        .s_axi_rvalid(s_axi_rvalid));
  bd_e34f_s00sic_0 s00_si_converter
       (.aclk(aclk),
        .aresetn(aresetn),
        .m_axi_araddr(m_axi_araddr),
        .m_axi_arcache(m_axi_arcache),
  ...
  bd_e34f_s00tr_0 s00_transaction_regulator
       (.aclk(aclk),
        .aresetn(aresetn),
...
module s01_entry_pipeline_imp_1YL7H1W
   (aclk,
    aresetn,
    m_axi_awaddr,
    m_axi_awcache,
  ...
  bd_e34f_s01mmu_0 s01_mmu
       (.aclk(aclk),
        ...
        .s_axi_wstrb(s_axi_wstrb),
        .s_axi_wvalid(s_axi_wvalid));
  bd_e34f_s01sic_0 s01_si_converter
       (.aclk(aclk),
        .aresetn(aresetn),
        .m_axi_awaddr(m_axi_awaddr),
        .m_axi_awcache(m_axi_awcache),
  ...
  bd_e34f_s01tr_0 s01_transaction_regulator
       (.aclk(aclk),
        .aresetn(aresetn),
...
module switchboards_imp_7L12VI
   (M00_SC_AR_info,
    M00_SC_AR_payld,
    M00_SC_AR_recv,
    M00_SC_AR_req,
