...
simulate()
{
  xsim matrix_in_memeory -key {Behavioral:sim_1:Functional:matrix_in_memeory} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_0b88.protoinst" -protoinst "protoinst_files/bd_e34f.protoinst" -protoinst "protoinst_files/bd_c88b.protoinst" -protoinst "protoinst_files/Systolic_DMA_AXI_Stream.protoinst" -log simulate.log
}
