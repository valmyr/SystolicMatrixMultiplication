...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_36 -L axi_vip_v1_1_22 -L gigantic_mux -L xlconcat_v2_1_7 -L zynq_ultra_ps_e_vip_v1_0_22 -L axi_datamover_v5_1_37 -L axi_sg_v4_1_21 -L axi_dma_v7_1_37 -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_17 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Systolic_DMA_AXI_Stream xil_defaultlib.Systolic_DMA_AXI_Stream xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Systolic_DMA_AXI_Stream -key {Behavioral:sim_1:Functional:Systolic_DMA_AXI_Stream} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_0b88.protoinst" -protoinst "protoinst_files/bd_e34f.protoinst" -protoinst "protoinst_files/bd_c88b.protoinst" -protoinst "protoinst_files/Systolic_DMA_AXI_Stream.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Systolic_DMA_AXI_Stream.wdb xsim.dir libdpi.so)
