...
simulate()
{
  xsim ila_1 -key {Behavioral:sim_1:Functional:ila_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_cb49.protoinst" -protoinst "protoinst_files/bd_e34f.protoinst" -protoinst "protoinst_files/bd_c88b.protoinst" -protoinst "protoinst_files/Systolic_DMA_AXI_Stream.protoinst" -log simulate.log
}
