...
simulate()
{
  xsim ila_0 -key {Behavioral:sim_1:Functional:ila_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_cb49.protoinst" -protoinst "protoinst_files/bd_e34f.protoinst" -protoinst "protoinst_files/bd_c88b.protoinst" -protoinst "protoinst_files/Systolic_DMA_AXI_Stream.protoinst" -log simulate.log
}
