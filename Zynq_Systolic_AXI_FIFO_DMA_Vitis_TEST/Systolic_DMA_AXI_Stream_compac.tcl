...
################################################################
# This is a generated script based on design: Systolic_DMA_AXI_Stream
#
...
# source Systolic_DMA_AXI_Stream_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# row_major_axi_convert, AXI_Stream_Systolic_Core
...
set design_name Systolic_DMA_AXI_Stream
...
# Hierarchical cell: SystolicCore_Wrapper
proc create_hier_cell_SystolicCore_Wrapper { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_SystolicCore_Wrapper() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: row_major_axi_convert_0, and set properties
  set block_name row_major_axi_convert
  set block_cell_name row_major_axi_convert_0
  if { [catch {set row_major_axi_convert_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $row_major_axi_convert_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property CONFIG.BYTESIZES {8} $row_major_axi_convert_0


  # Create instance: AXI_Stream_Systolic_0, and set properties
  set block_name AXI_Stream_Systolic_Core
  set block_cell_name AXI_Stream_Systolic_0
  if { [catch {set AXI_Stream_Systolic_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $AXI_Stream_Systolic_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [list \
    CONFIG.BYTESIZES {8} \
    CONFIG.SIZE {2} \
  ] $AXI_Stream_Systolic_0


  # Create interface connections
  connect_bd_intf_net -intf_net AXI_Stream_Systolic_0_m_axis [get_bd_intf_pins AXI_Stream_Systolic_0/m_axis] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  connect_bd_intf_net -intf_net [get_bd_intf_nets AXI_Stream_Systolic_0_m_axis] [get_bd_intf_pins AXI_Stream_Systolic_0/m_axis] [get_bd_intf_pins m_axis]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins s_axis1] [get_bd_intf_pins row_major_axi_convert_0/s_axis]
  set_property SIM_ATTRIBUTE.MARK_SIM "true" [get_bd_intf_nets /SystolicCore_DMA/SystolicCore_Wrapper/axi_dma_0_M_AXIS_MM2S]
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS1 [get_bd_intf_pins M_AXIS1] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
  connect_bd_intf_net -intf_net row_major_axi_convert_0_m_axis [get_bd_intf_pins AXI_Stream_Systolic_0/s_axis] [get_bd_intf_pins row_major_axi_convert_0/m_axis]
  connect_bd_intf_net -intf_net [get_bd_intf_nets row_major_axi_convert_0_m_axis] [get_bd_intf_pins AXI_Stream_Systolic_0/s_axis] [get_bd_intf_pins s_axis]

  # Create port connections
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn  [get_bd_pins resetn] \
  [get_bd_pins AXI_Stream_Systolic_0/resetn] \
  [get_bd_pins row_major_axi_convert_0/resetn] \
  [get_bd_pins axis_data_fifo_0/s_axis_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0  [get_bd_pins clock] \
  [get_bd_pins AXI_Stream_Systolic_0/clock] \
  [get_bd_pins row_major_axi_convert_0/clock] \
...
# Hierarchical cell: SystolicCore_DMA
proc create_hier_cell_SystolicCore_DMA { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_SystolicCore_DMA() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: SystolicCore_Wrapper
  create_hier_cell_SystolicCore_Wrapper $hier_obj SystolicCore_Wrapper

  # Create interface connections
  connect_bd_intf_net -intf_net AXI_Stream_Systolic_0_m_axis [get_bd_intf_pins m_axis] [get_bd_intf_pins SystolicCore_Wrapper/m_axis]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins SystolicCore_Wrapper/s_axis1] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  set_property SIM_ATTRIBUTE.MARK_SIM "true" [get_bd_intf_nets /SystolicCore_DMA/axi_dma_0_M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins S_AXI_LITE] [get_bd_intf_pins axi_dma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS1 [get_bd_intf_pins SystolicCore_Wrapper/M_AXIS1] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis_data_fifo_0_M_AXIS1] [get_bd_intf_pins SystolicCore_Wrapper/M_AXIS1] [get_bd_intf_pins M_AXIS1]
  connect_bd_intf_net -intf_net row_major_axi_convert_0_m_axis [get_bd_intf_pins s_axis] [get_bd_intf_pins SystolicCore_Wrapper/s_axis]

  # Create port connections
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn  [get_bd_pins resetn] \
  [get_bd_pins SystolicCore_Wrapper/resetn] \
  [get_bd_pins axi_dma_0/axi_resetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0  [get_bd_pins m_axi_mm2s_aclk] \
  [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] \
  [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] \
  [get_bd_pins SystolicCore_Wrapper/clock] \
...
\
  ...
  # Create instance: SystolicCore_DMA
  create_hier_cell_SystolicCore_DMA [current_bd_instance .] SystolicCore_DMA

  # Create interface connections
connect_bd_intf_net -intf_net AXI_Stream_Systolic_0_m_axis [get_bd_intf_pins SystolicCore_DMA/m_axis] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets AXI_Stream_Systolic_0_m_axis]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins SystolicCore_DMA/M_AXI_MM2S] [get_bd_intf_pins axi_smc_1/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins SystolicCore_DMA/M_AXI_S2MM] [get_bd_intf_pins axi_smc_1/S01_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_smc_1_M00_AXI] [get_bd_intf_pins axi_smc_1/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_3_AXI]
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins SystolicCore_DMA/S_AXI_LITE]
connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS1 [get_bd_intf_pins SystolicCore_DMA/M_AXIS1] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_data_fifo_0_M_AXIS1]
connect_bd_intf_net -intf_net row_major_axi_convert_0_m_axis [get_bd_intf_pins SystolicCore_DMA/s_axis] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets row_major_axi_convert_0_m_axis]
  ...
  [get_bd_pins SystolicCore_DMA/resetn]
  ...
  [get_bd_pins SystolicCore_DMA/m_axi_mm2s_aclk]
  ...
  assign_bd_address -offset 0xB0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs SystolicCore_DMA/axi_dma_0/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces SystolicCore_DMA/axi_dma_0/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces SystolicCore_DMA/axi_dma_0/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_QSPI] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces SystolicCore_DMA/axi_dma_0/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces SystolicCore_DMA/axi_dma_0/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_QSPI] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces SystolicCore_DMA/axi_dma_0/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces SystolicCore_DMA/axi_dma_0/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces SystolicCore_DMA/axi_dma_0/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces SystolicCore_DMA/axi_dma_0/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM]
