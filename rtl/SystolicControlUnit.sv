...
enum {IDLE,WRITE_MEM,SYSTOLIC_READ_MEM,SEND_FPGA2HOST} fsm_unit_control, fsm_unit_control_next;
...
always_comb case(fsm_unit_control)
    ...
    SEND_FPGA2HOST:begin
        ...
        uart_valid_tx_in           =  1;
        //fsm_unit_control_next      = mem2serial_rvalid_o && counter_out_send_fpga2host >= 3*SIZE-1 +5 ? IDLE: SEND_FPGA2HOST;
...
ila_2 your_instance_name2 (
	...
	.probe0(frame_start), // input wire [15:0]  probe0  
	.probe1(fsm_unit_control), // input wire [15:0]  probe1 
	.probe2(uart_data_rx_out), // input wire [15:0]  probe2 
	.probe3(serial2mem_opa_rvalid_o), // input wire [15:0]  probe3 
	.probe4(serial2mem_opb_rvalid_o), // input wire [15:0]  probe4 
	.probe5(serial2mem_opa_ready_o ), // input wire [0:0]  probe5 
