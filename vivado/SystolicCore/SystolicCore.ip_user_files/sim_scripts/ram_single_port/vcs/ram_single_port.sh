...
#
# Script generated by Vivado on Sat Nov 08 20:39:58 -03 2025
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ram_single_port.sh
...
#
# Usage        : ram_single_port.sh
#                ram_single_port.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ram_single_port.sh [-reset_run]
#                ram_single_port.sh [-reset_log]
#                ram_single_port.sh [-help]
#
...
#                script (type 'ram_single_port.sh -help' for more information).
#
...
# script info
echo -e "ram_single_port.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ram_single_port.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../../amd/2025.1/data/rsb/busdef" \
  ...
  vlogan -work blk_mem_gen_v8_4_11 $vlogan_opts +v2k +incdir+"../../../../../../../../../../amd/2025.1/data/rsb/busdef" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../../../amd/2025.1/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ram_single_port xil_defaultlib.glbl -o ram_single_port_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ram_single_port_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/xmen/Desktop/compara/analise/SystolicMatrixMultiplication/vivado/SystolicCore/SystolicCore.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key ram_single_port_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ram_single_port_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ram_single_port.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ram_single_port.sh [-help]\n\
Usage: ram_single_port.sh [-step]\n\
Usage: ram_single_port.sh [-lib_map_path]\n\
Usage: ram_single_port.sh [-reset_run]\n\
Usage: ram_single_port.sh [-reset_log]\n\
Usage: ram_single_port.sh [-keep_index]\n\
Usage: ram_single_port.sh [-noclean_files]\n\n\
