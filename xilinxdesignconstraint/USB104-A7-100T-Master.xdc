...
## Buttons
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { nrst }]; #IO_L16N_T2_A15_D31_14 Sch=btn[0]
#set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { btn[1] }]; #IO_L17P_T2_A14_D30_14 Sch=btn[1]

## LEDs
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { led}]; #IO_L12N_T1_MRCC_14 Sch=led[0]
