...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../amd/2025.1/data/rsb/busdef" +incdir+"../../../../project_1.gen/sources_1/ip/ila_0_1/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../../amd/2025.1/data/rsb/busdef" +incdir+"../../../../project_1.gen/sources_1/ip/ila_0_1/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/xmen/Desktop/compara/analise/SystolicMatrixMultiplication/project_1/project_1.cache/compile_simlib/xcelium"
  fi
